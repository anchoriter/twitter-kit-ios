Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/anchoriter/twitter-kit-ios"
  s.documentation_url = "https://github.com/anchoriter/twitter-kit-ios/wiki"
  s.social_media_url = ""
  s.authors = "Anchoriter"
  s.platform = :ios, "9.0"
  s.source = { :http => "https://github.com/anchoriter/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
  ...
  s.dependency "TwitterCore", ">= 3.4.2"
end
